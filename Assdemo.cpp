...
int main(){
 person p1("Ibrahim","Rangpur","0177********","khan@gmail","lajimkhan");
 p1.getinfo();
 Employee e1("Korim","Uttora","0178*******","korim@gmail","korimkhan","Servay officer","15000","5 yr");
 e1.getinfo();
 officer o1("Rohim","Mirpur","01589******","rohim@gmail","5 yr","manager","rohimkhan","Fild officer","20000");
 o1.getinfo();
 faculty f1("Siam","Lalbug","01999******","siam@gmail","siamahmed","Teacher","30000","EEE","Dhaka University","");
 f1.getinfo();
 student s1("Rohan","Kumilla","0155********","rohan@gmail","rohan kobir",3.50);
 s1.getinfo();
 ta t1("Kutub","Kurigram","0188********","kutub@gmail","kutubuddin",3.95, "2 years","","");
 t1.getinfo();
 scholarship_student ss1("Lajim","Rangpur","01776******","lajim3923@gmail","lajimmostakim",3.95,50);
 ss1.getinfo();
